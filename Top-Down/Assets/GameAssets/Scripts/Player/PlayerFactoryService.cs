...
namespace TopDown {
  public class PlayerFactoryService {
    ...
    public void Create(PlayerType type) {
      ...
      PlayerController.Initialize(_playerInputService, _enemyProvider, playerInfo.MoveSpeed, playerInfo.RotationSpeed,
                                  playerInfo.Health, playerInfo.NumberOfBullets, playerInfo.CountShotPerMinute,
